pipeline {
  ...
  environment {
        ...
        SONARQUBE_TAGS = "www.eea.europa.eu,climate-advisory-board.europa.eu,demo-www.eea.europa.eu,forest.eea.europa.eu,www.eea.europa.eu-en,biodiversity.europa.eu,insitu.copernicus.eu,clmsdemo.devel6cph.eea.europa.eu,land.copernicus.eu,demo-ied.eea.europa.eu,www.ied.eea.europa.eu-en,demo-water.devel5cph.eea.europa.eu-freshwater"
    }
